...
const toLastNames = people => {
  // Solution code here...
  let fullName = people.map(name => `${name.firstName} ${name.lastName}`);
  return fullName;
};
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  return arr.reduce((accumulator, value, idx) => idx + 1, 0);
};
...
const returnNames = (arr) => {
  // Solution code here...
  return starWarsData.reduce((accumulator, value) => {
...
const reversedString = (str) => {
  // Solution code here...
  let restr = str.split('');
  return restr.reduce((accumulator, value) => {
